...
/**
 * broker与客户端的交互组件
 * 主动推送请求给客户端，用于检查生产者事务状态、通知同一消费组中消费者变化、查询消费状态
 */
public class Broker2Client {
    ...
    /**
     * 检查生产者事务状态
     * 当生产者发送事务消息时，首先发送half消息，如果成功才会commit事务，否则rollback
     * 当连接断开后broker会内部检查事务消息状态并回调生产者客户端检查本地事务状态
     *
     * @param group         生产组
     * @param channel       网络连接信息
    ...
    public void checkProducerTransactionState(
        ...
        // 发现有half消息超出一定时间还没有提交或者回滚时，broker内部会主动构造请求
        // 推送给生产者驱动其查询本地事务状态
    ...
    public RemotingCommand resetOffset(String topic,
                                       String group,
                                       long timeStamp,
                                       boolean isForce,
                                       boolean isC) {
